...
// Apply the CORS policy before defining any endpoints
...
app.MapGet("/events", async (HttpClient httpClient) =>
{
    var response = await httpClient.GetAsync("https://gui230.jitdesigns.com/api/events");
